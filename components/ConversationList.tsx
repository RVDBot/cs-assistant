...
export default function ConversationList({ selectedId, onSelect, onOpenSettings, onOpenContext, onOpenKnowledge }: Props) {
  ...
  return (
    <div className="flex flex-col h-full w-[360px] min-w-[300px] border-r border-whatsapp-border bg-whatsapp-panel">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto">
        {loading && (
          <div className="flex items-center justify-center h-20 text-whatsapp-muted text-sm">
            Laden...
          </div>
        )}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between gap-2">
                <span className="text-whatsapp-muted text-xs truncate">
                  {conv.last_message || 'Nieuw gesprek'}
                </span>
